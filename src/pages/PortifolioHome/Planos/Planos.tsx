            ...
            <div className="border rounded-sm shadow-md h-full flex flex-col">
              ...
              <div className="p-4 flex flex-col gap-3 flex-1">
                ...
                <p className="text-gray-300 text-sm">
                  ...
                  Ideal para quem busca hipertrofia, perda de gordura ou
                  recomposição corporal com suporte constante e metodologia
                  profissional.
                </p>
                <span className="text-2xl font-bold text-white">
                  R$ {PlanosData.Mensal.preçoMensal}/mês
                </span>
                <p className="text-xs text-gray-500 mt-1">
                  {PlanosData.Mensal.totalLabelMensal}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="border rounded-sm shadow-md h-full flex flex-col">
              ...
              <div className="p-4 flex flex-col gap-3 flex-1">
                ...
                <p className="text-gray-300 text-sm">
                  ...
                  evolutivo, treinos periodizados e suporte contínuo, garantindo
                  constância e resultados sólidos.
                </p>
                <span className="text-2xl font-bold text-white">
                  R$ {PlanosData.Semestral.preçoSemestral}/mês
                </span>
                <p className="text-xs text-gray-500 mt-1">
                  {PlanosData.Semestral.totalLabelSemestral}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="h-full">
            <div className="border rounded-sm shadow-md h-full flex flex-col">
              ...
              <div className="p-4 flex flex-col gap-3 flex-1">
                ...
                <span className="text-2xl font-bold text-white">
                  R$ {PlanosData.Anual.preçoAnual}/ano
                </span>
                <p className="text-xs text-gray-500 mt-1">
                  {PlanosData.Anual.totalLabelAnual}
                </p>
              </div>
            </div>
          </div>
