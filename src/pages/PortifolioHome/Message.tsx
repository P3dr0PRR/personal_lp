...
export function Message() {
  return (
    <section className="sections-appear sections flex flex-col space-y-4 mt-12">
      ...
      <a
        href="#"
        className="cursor-pointer italic bg-cta-lime hover:scale-110  transition-transform duration-300 rounded-md mx-12 p-6 text-center font-bold text-lg text-gray-900"
      >
      ...
      <div className="flex items-start">
        <div className="flex items-center">
          <img
            src={Mensal}
            alt="Mensal"
            className=" hover:scale-110 transition-transform duration-300rounded-full w-8 h-8 object-cover"
          />
          <img
            src={Semestral}
            alt="Semestral"
            className=" hover:scale-110 transition-transform duration-300 rounded-full w-8 h-8 object-cover"
          />
          <img
            src={Anual}
            alt="Anual"
